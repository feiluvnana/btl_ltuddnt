...
mixin _$OverlayState {
  OverlayEntry? get entry => throw _privateConstructorUsedError;
...
class _$OverlayStateImpl implements _OverlayState {
  const _$OverlayStateImpl({this.entry});
  ...
  @override
  String toString() {
    return 'OverlayState(entry: $entry)';
  }
...
abstract class _OverlayState implements OverlayState {
  const factory _OverlayState({final OverlayEntry? entry}) = _$OverlayStateImpl;
